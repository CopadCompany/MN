import Bannerbg from '../assets/banner.jpg';
  const stats = [
    { name: 'Matricula', value: 'M.P1402' },
    { name: 'Pacientes rehabilitados', value: '500+' },
    { name: 'Consultorios', value: '2' },
    { name: 'Ubicación', value: 'General Roca' },
  ]
  
  export default function Banner() {
    return (
      // Para el banner
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 pt-[60px] lg:pt-[72px]" >

      <div className="absolute inset-0 -z-10 h-full w-full ">
        <img
          src={Bannerbg}
          alt=""
          className="h-full w-full object-cover md:object-center opacity-80"
